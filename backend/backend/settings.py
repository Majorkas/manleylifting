...
ACCOUNT_EMAIL_LOGO_URL = os.getenv("ACCOUNT_EMAIL_LOGO_URL", "").strip()
ACCOUNT_SUPPORT_EMAIL = os.getenv("ACCOUNT_SUPPORT_EMAIL", "").strip()
ACCOUNT_SUPPORT_PHONE = os.getenv("ACCOUNT_SUPPORT_PHONE", "").strip()
ACCOUNT_MFA_ISSUER = os.getenv("ACCOUNT_MFA_ISSUER", "").strip()
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "api.authentication.AccountJWTAuthentication",
    ),
